...
export default function AMSSlotPlanner() {
  // Input States
  const [modelColor, setModelColor] = useState<string>('Gray PLA');
  const [accentColor, setAccentColor] = useState<string>('Red PLA');
  const [supportColor, setSupportColor] = useState<string>('Support W (Breakaway)');
  ...
  useEffect(() => {
    try {
      ...
      return {
        'Recommended AMS slots': `Slot 1: ${modelColor} | Slot 2: ${accentColor} | Slot 3: ${supportColor} | Slot 4: Empty`
      };
  ...
  }, [modelColor, accentColor, supportColor]);
        ...
        <div className="md:col-span-6 p-6 saas-card space-y-4">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Model Core Color</label>
              <input
                type="text"
                value={modelColor}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Model Accent Color</label>
              <input
                type="text"
                value={accentColor}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Support Interface Filament</label>
              <input
                type="text"
                value={supportColor}
