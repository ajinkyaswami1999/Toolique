...
export default function ShippingCostCalculator() {
  ...
  const [weightSurcharge, setWeightSurcharge] = useState<number>(50);
  ...
  useEffect(() => {
    try {
      ...
      const cost = baseRate + (extraKg * weightSurcharge);
      return {
  ...
  }, [weightKg, baseRate, weightSurcharge]);
        ...
        <div className="md:col-span-6 p-6 saas-card space-y-4">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Package Weight (kg)</label>
              <input
                type="number"
                value={weightKg}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Base Delivery Rate (₹)</label>
              <input
                type="number"
                value={baseRate}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Additional kg Surcharge (₹)</label>
              <input
                type="number"
