...
export default function LinkedInBannerResizer() {
  ...
  }, [imageSrc, zoom, rotation, offsetX, offsetY, fitMode, format]);
  ...
  const downloadImage = () => {
    ...
    link.download = `linkedin-banner-${Date.now()}.${format}`;
    link.href = dataUrl;
    link.click();
  };
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
      ...
      <div className="lg:col-span-5 saas-card p-6 space-y-6">
        <h3 className="text-base font-bold text-zinc-900 dark:text-white flex items-center gap-2 pb-3 border-b border-zinc-100 dark:border-zinc-850">
          ...
          <span>Upload & Resize Banner</span>
        </h3>
        ...
        {!imageSrc ? (
          ...
          >
            ...
            <p className="text-sm font-bold text-zinc-700 dark:text-zinc-250">Drag & Drop Banner Image</p>
      ...
      <div className="lg:col-span-7 saas-card p-6 flex flex-col justify-between space-y-6">
        <div>
          <h3 className="text-base font-bold text-zinc-900 dark:text-white pb-3 border-b border-zinc-100 dark:border-zinc-855 mb-4">
            LinkedIn Banner Preview (1584 × 396)
          </h3>
          <p className="text-xs text-zinc-400 dark:text-zinc-500 mb-4 leading-relaxed">
            Standard 4:1 banner format for LinkedIn profiles. Live workspace auto-scales width.
          </p>

          <div className="relative w-full rounded-xl bg-zinc-900 overflow-hidden flex items-center justify-center border border-zinc-800 p-4 shadow-inner min-h-[220px]">
            {imageSrc ? (
              <div className="w-full border border-zinc-700/50 rounded overflow-hidden flex items-center justify-center shadow-md aspect-[1584/396]">
                <canvas
                  ref={canvasRef}
              ...
              <div className="text-center text-zinc-600 dark:text-zinc-700 space-y-2">
                ...
                <p className="text-xs max-w-xs leading-normal">Load a banner photograph to build your standard crop layout.</p>
              </div>
            )}
          </div>
        </div>
        ...
        {imageSrc && (
          <div className="p-4 rounded-xl bg-zinc-50/50 dark:bg-zinc-950/40 border border-zinc-200/60 dark:border-zinc-855 flex justify-between text-xs font-semibold text-zinc-500 dark:text-zinc-400">
            <span>Dimensions: {TARGET_WIDTH} x {TARGET_HEIGHT} (4:1)</span>
