...
export default function ModelWeightCalculator() {
  // Input States
  ...
  useEffect(() => {
    try {
      ...
      return {
        'Computed Mass Weight': weight.toFixed(2) + ' grams',
        'Standard Spool Usage': ((weight / 1000) * 100).toFixed(1) + '%'
      };
        ...
        <div className="md:col-span-6 p-6 saas-card space-y-4">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Model Volume (cm³)</label>
              <input
                type="number"
                value={volume}
