...
export default function BlueprintAreaCalculator() {
  ...
  const copyReport = () => {
    const text = `Blueprint Area Calculator Report\nParameter 1: ${val1}\nParameter 2: ${val2}\nCalculated Result: ${result}`;
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4 pt-4 border-t border-zinc-100 dark:border-zinc-800 text-[10px] text-zinc-400 leading-relaxed">
              <p>Calculations conform to standard architectural formulas for Blueprint Area Calculator under subcategory Drawing & Scale Tools.</p>
            </div>
          </div>
        </div>
      </div>
