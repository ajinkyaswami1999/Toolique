...
export default function LayerWidthCalculator() {
  // Input States
  const [nozzleSize, setNozzleSize] = useState<number>(0.4);
  const [walls, setWalls] = useState<number>(3);
  ...
  useEffect(() => {
    try {
      ...
      const totalWidth = lineWidth * walls;
      return {
        'Single Path Width': lineWidth.toFixed(2) + ' mm',
        'Total Shell Thickness': totalWidth.toFixed(2) + ' mm'
      };
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-6 p-6 saas-card space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Perimeter Wall Count</label>
              <input
                type="number"
                value={walls}
