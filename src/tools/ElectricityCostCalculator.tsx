...
export default function ElectricityCostCalculator() {
  ...
  useEffect(() => {
    try {
      ...
      return {
        'Power Consumed': kwh.toFixed(2) + ' kWh',
        'Total Power Cost': '₹' + cost.toFixed(2)
      };
        ...
        <div className="md:col-span-6 p-6 saas-card space-y-4">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Average Power Draw (W)</label>
              <input
                type="number"
                value={power}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Print Duration (hours)</label>
              <input
                type="number"
                value={hours}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Electricity Tariff (₹/kWh)</label>
              <input
                type="number"
                value={tariff}
