...
export default function AMSFilamentPlanner() {
  // Input States
  const [slot1, setSlot1] = useState<string>('White PLA');
  const [slot2, setSlot2] = useState<string>('Black PLA');
  const [slot3, setSlot3] = useState<string>('Red PLA');
  const [slot4, setSlot4] = useState<string>('Support G');
  ...
  useEffect(() => {
    try {
      ...
      return {
        'AMS Configuration Mapping': `Slot 1: ${slot1} | Slot 2: ${slot2} | Slot 3: ${slot3} | Slot 4: ${slot4}`
      };
        ...
        <div className="md:col-span-6 p-6 saas-card space-y-4">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Slot 1 Color</label>
              <input
                type="text"
                value={slot1}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Slot 2 Color</label>
              <input
                type="text"
                value={slot2}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Slot 3 Color</label>
              <input
                type="text"
                value={slot3}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Slot 4 Color</label>
              <input
                type="text"
                value={slot4}
