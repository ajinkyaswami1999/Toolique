...
export default function PrintSpeedCalculator() {
  // Input States
  ...
  useEffect(() => {
    try {
      ...
      return {
        'Average Speed': speed.toFixed(1) + ' mm/s',
        'Hour Yield Rate': ((distance / 1000) / (duration / 60)).toFixed(2) + ' m/hour'
      };
        ...
        <div className="md:col-span-6 p-6 saas-card space-y-4">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Travel Distance (mm)</label>
              <input
                type="number"
                value={distance}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-zinc-550 dark:text-zinc-400">Print Duration (minutes)</label>
              <input
                type="number"
                value={duration}
