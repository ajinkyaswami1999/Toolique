...
export default function RoomVentilationCalculator() {
  ...
  const copyReport = () => {
    const text = `Room Ventilation Calculator Report\nParameter 1: ${val1}\nParameter 2: ${val2}\nCalculated Result: ${result}`;
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4 pt-4 border-t border-zinc-100 dark:border-zinc-800 text-[10px] text-zinc-400 leading-relaxed">
              <p>Calculations conform to standard architectural formulas for Room Ventilation Calculator under subcategory Lighting & Environmental.</p>
            </div>
          </div>
        </div>
      </div>
